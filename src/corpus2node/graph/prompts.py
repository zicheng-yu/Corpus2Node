...
语言要求：
- definition、summary、key_points、tags、prerequisites、applications 等解释字段统一使用简体中文，不输出中英混杂的完整句子。
- name 采用最适合展示的中文名称；算法、模型、数据集等正式英文专名无法准确翻译时可保留英文。
- canonical_name 采用学术界常用规范名；aliases 同时收录中文译名、英文全称和缩写，避免为同一术语创建中英文重复节点。
